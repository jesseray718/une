...
"""Wire real f5/f6 into core_atomic.py, replacing mock stubs."""
import os, sys
...
NEW_CORE = '''#!/data/data/com.termux/files/usr/bin/python3
"""
...
TARGET.write_text(NEW_CORE)
print(f"Wrote {len(NEW_CORE)} bytes to {TARGET}")

# Run pipeline to verify
print("\n🧪 Running f1-f11 pipeline...\n")
import subprocess
result = subprocess.run(
    [sys.executable, str(TARGET), "pipeline"],
